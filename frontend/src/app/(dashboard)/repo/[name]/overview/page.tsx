...
export default function RepoOverviewPage() {
  ...
  const healthLabel = healthStatus === "healthy" ? "Synkronisert" : healthStatus === "error" ? "Problemer" : healthStatus === "warning" ? "Advarsler" : "Ukjent";
          ...
          <>
            ...
            <div className="mt-6" style={{ border: "1px solid var(--border)" }}>
              <div className="px-4 py-3" style={{ borderBottom: "1px solid var(--border)" }}>
                <span className="text-sm font-medium" style={{ color: "var(--text-primary)" }}>Snarveier</span>
              </div>
              <div className="grid grid-cols-2 gap-0">
                <Link
                  href={`/repo/${params.name}/chat`}
                  className="px-4 py-3 text-sm hover:bg-white/5 transition-colors"
                  style={{ borderRight: "1px solid var(--border)", borderBottom: "1px solid var(--border)", color: "var(--text-secondary)" }}
                >
                  Chat med AI
                </Link>
                <Link
                ...
                <Link
                  href={`/repo/${params.name}/activity`}
                  className="px-4 py-3 text-sm hover:bg-white/5 transition-colors"
